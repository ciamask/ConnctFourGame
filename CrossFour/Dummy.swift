...
/*
 ...
 struct ContentView: View {
     ...
     func computerTurn() {
             ...
             for col in 0...3 {
                 if (self.hole[7*row+col] != .blank &&
                     ...
                     if (7*row+col+31 <= 41 && self.hole[7*row+col+31] != .blank) {
                         comptureDrop(col:col+24, row:row+3)
                         return
             ...
             for col in 3...6 {
                 if (self.hole[7*row+col] == .blank &&
                     ...
                     if (7*row+col+25 <= 41 && self.hole[7*row+col+25] != .blank) {
                         comptureDrop(col:col+18, row:row+3)
                         return
         ...
         comptureDrop(col: col, row: blankNum)
         
     }
     
     func comptureDrop(col: Int, row: Int) {
         var idx = col % 7
         for i in 0...row {
             DispatchQueue.main.asyncAfter(deadline: .now() + 0.12*Double(i)) {
                 if(idx>6) {
